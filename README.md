...
| Requirements | 58, of which 55 `Done` and each names a test that exists |
| Defects logged | 25, of which 7 severity 1 |
| ADRs | 13 |
...
- 3 of 58 requirements are still `Planned`, and the matrix says so rather than
  rounding up. 20 of the other 55 were `Planned` too, until an audit requested
